...
const NOTIFICATIONS = [
  {
    ...
    message: "Ya puedes elegir tus talleres desde la sección de Agenda. El cupo es limitado para las sesiones de la tarde. Te recomendamos elegir pronto para asegurar tu lugar en los temas de tu interés.",
  ...
  },
  {
    ...
    message: "La conferencia magistral de las 10:00 AM se ha movido al Auditorio Principal (Planta Alta).",
    fullContent: "Debido a la alta demanda y para mayor comodidad de todos los asistentes, la conferencia del Dr. Armando Guerra se llevará a cabo en el Auditorio Principal en lugar de la Sala B. Agradecemos su comprensión.",
    type: "urgent",
    time: "Hace 15 min",
    isPinned: false,
  },
  {
    ...
    message: "Ya puedes recoger tu playera oficial y gafete en el lobby principal.",
    fullContent: "El área de registro estará entregando kits de bienvenida hasta las 6:00 PM. Es indispensable presentar tu código QR digital o el ID de registro para recibir tu material.",
    type: "info",
    time: "Hace 2 horas",
    isPinned: false,
  },
  {
    ...
    message: "Te esperamos a las 8:00 PM en el jardín central para nuestra noche de apertura.",
    fullContent: "Preparamos una noche especial con música en vivo y una cena tradicional para dar inicio a este gran congreso. El punto de reunión es el jardín central del Centro de Convenciones.",
    type: "event",
    time: "Hace 5 horas",
    isPinned: false,
  }
    ...
    <div className="w-full max-w-6xl mx-auto flex flex-col p-4 sm:p-8 space-y-8 pb-32 md:pb-12">
      <header className="flex flex-col md:flex-row md:items-end justify-between gap-4 text-center md:text-left border-b border-gray-100 pb-8">
        ...
        <div className="flex justify-center gap-2">
           <Button variant="ghost" size="sm" className="text-[10px] font-black uppercase text-gray-400 hover:text-primary">Marcar todo como leído</Button>
        </div>
      </header>
        ...
        <div className="lg:col-span-8 space-y-10">
          ...
          <section className="space-y-4">
            <div className="flex items-center gap-2 px-2 text-primary">
               ...
               <h2 className="text-[10px] font-black uppercase tracking-widest">Anuncio Fijado</h2>
            </div>
                ...
                <DashboardCard className="bg-primary/5 border-primary/20 relative overflow-hidden group">
                  ...
                  <div className="flex gap-5">
                    ...
                    <div className="space-y-2 relative z-10 text-left">
                      ...
                      <p className="text-sm text-secondary/70 leading-relaxed font-medium">{notif.message}</p>
                      <div className="pt-2 flex items-center gap-4">
                         ...
                         <span className="text-[9px] font-black text-primary uppercase tracking-widest">{notif.time}</span>
                      </div>
                    </div>
                  </div>
                </DashboardCard>
          ...
          <section className="space-y-6">
            <div className="flex items-center gap-2 px-2 text-gray-400">
               <Clock size={14} />
               <h2 className="text-[10px] font-black uppercase tracking-widest">Recientes</h2>
            </div>
              ...
              {NOTIFICATIONS.filter(n => !n.isPinned).map((notif, idx) => (
                ...
                >
                  ...
                  <div 
                    ...
                    tabIndex={0}
                    onClick={() => openDetails(notif)}
                    onKeyDown={(e) => (e.key === 'Enter' || e.key === ' ') && openDetails(notif)}
                    ...
                    <div className="flex gap-4 items-start">
                      <div className={cn(
                        ...
                        {notif.type === 'urgent' ? <AlertTriangle size={18} /> : 
                         notif.type === 'info' ? <Info size={18} /> : <MessageSquare size={18} />}
                      </div>
                      ...
                      <div className="flex-1 space-y-1">
                        <div className="flex justify-between items-start">
                          ...
                          <span className="text-[9px] font-black text-gray-300 uppercase tracking-widest">{notif.time}</span>
                        </div>
                        <p className="text-xs text-gray-500 leading-relaxed font-medium">
                          {notif.message}
                        </p>
                      </div>
                      <ChevronRight size={16} className="text-gray-200 mt-1 group-hover:text-primary group-hover:translate-x-1 transition-all" />
                    </div>
                  </div>
                </motion.div>
              ))}
        ...
        <aside className="lg:col-span-4 space-y-6">
          <DashboardCard title="Ayuda">
             <div className="space-y-6">
                <p className="text-xs text-gray-500 leading-relaxed">
                  ¿Tienes dudas sobre el programa o problemas con tu acceso? Nuestro staff está listo para ayudarte.
                </p>
                <Button 
                  variant="outline" 
          ...
          <div className="bg-secondary rounded-[2rem] p-8 text-white relative overflow-hidden shadow-xl">
             <div className="relative z-10 flex flex-col items-center text-center">
                ...
                <h3 className="text-lg font-black uppercase tracking-tighter leading-tight">Gafete Digital Validado</h3>
                <p className="text-[10px] text-white/40 uppercase tracking-[0.2em] mt-2">No necesitas imprimir nada</p>
             </div>
      ...
      <Modal isOpen={isSupportModalOpen} onClose={() => setIsSupportModalOpen(false)}>
        <ModalHeader onClose={() => setIsSupportModalOpen(false)}>
          <ModalTitle className="text-2xl font-black uppercase tracking-tighter">Mandar <span className="text-primary">Mensaje</span></ModalTitle>
        ...
        <ModalContent className="space-y-6 pt-4">
          <div className="space-y-4">
            <p className="text-xs text-gray-500 font-medium bg-gray-50 p-4 rounded-xl border border-gray-100 italic">
              "Hola staff, necesito ayuda con mi registro en los talleres de la tarde..."
            </p>
            <div className="space-y-1.5">
              <label className="text-[10px] font-black text-secondary uppercase tracking-widest ml-1">Tu Mensaje</label>
              <textarea 
        ...
        <ModalFooter className="flex gap-3">
          ...
          >
            {isSending ? "Enviando..." : <><Send size={16} className="mr-2" /> Enviar</>}
          </Button>
        </ModalFooter>
      </Modal>
            ...
            <ModalHeader onClose={() => setIsDetailsModalOpen(false)}>
              <div className="flex items-center gap-3 mb-2">
                <span className={cn(
                  ...
                  selectedNotif.type === 'urgent' ? "bg-red-100 text-red-600" : "bg-primary/10 text-primary"
                )}>
                  {selectedNotif.type}
                </span>
            ...
            <ModalContent className="space-y-6 pt-2">
              ...
              <div className="p-4 bg-primary/5 rounded-2xl flex items-center gap-3 border border-primary/10">
                 ...
                 <p className="text-[10px] font-bold text-secondary/60 uppercase leading-tight">
                   Esta es una notificación oficial enviada por el comité organizador de CNGRS26.
                 </p>
              </div>
            </ModalContent>
            <ModalFooter>
              <Button className="w-full" onClick={() => setIsDetailsModalOpen(false)}>Entendido</Button>
            </ModalFooter>
          </>
        )}
      </Modal>

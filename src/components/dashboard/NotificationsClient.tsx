    ...
    <div className="w-full max-w-6xl mx-auto flex flex-col p-4 sm:p-8 space-y-8 pb-32 md:pb-12">
                  ...
                  <DashboardCard className="bg-primary/5 border-primary/20 relative overflow-hidden group">
                    ...
                    <div className="flex gap-5">
                      ...
                      <div className="space-y-2 relative z-10 text-left">
                        ...
                        <p className="text-sm text-secondary/70 leading-relaxed font-medium line-clamp-2">
                          {notif.message}
                        </p>
                        <div className="pt-2">
                          <Button
          ...
          <section className="space-y-6">
            ...
            <div className="relative pl-4 space-y-6 before:absolute before:left-0 before:top-2 before:bottom-2 before:w-0.5 before:bg-gray-100">
              {recentNotifs.length > 0 ? (
                      ...
                      <div className="flex gap-4 items-start">
                        ...
                        <div className="flex-1 space-y-1">
                          <div className="flex justify-between items-start">
                            <h3 className="font-black text-secondary uppercase tracking-tight text-base group-hover:text-primary transition-colors">
                              {notif.title}
                            </h3>
                          </div>
                        ...
                        <ChevronRight
                          size={16}
                          className="text-gray-200 mt-1 group-hover:text-primary transition-all"
                        />
                      </div>
                    </div>
                  </motion.div>
                ...
                <p className="text-xs font-bold text-gray-400 uppercase tracking-widest text-center py-10">
        ...
        <aside className="lg:col-span-4 space-y-6">
          <DashboardCard title="Ayuda">
            <div className="space-y-6">
              <p className="text-xs text-gray-500 leading-relaxed">
                ¿Dudas sobre el programa o problemas con tu acceso?
              </p>
              <Button
                variant="outline"
          ...
          <div className="bg-secondary rounded-[2rem] p-8 text-white relative overflow-hidden shadow-xl shadow-secondary/10">
            <div className="relative z-10 flex flex-col items-center text-center">
              <div className="h-16 w-16 bg-white/10 rounded-2xl flex items-center justify-center mb-4 border border-white/20">
      ...
      >
        ...
        <ModalContent className="space-y-6 pt-4">
          <textarea
            className="w-full min-h-[120px] bg-white border border-gray-300 rounded-xl p-4 text-sm focus:ring-2 focus:ring-primary focus:outline-none transition-all"
